 ...
 * @author marcu
 */
public class Hämta_Utrustning extends javax.swing.JFrame {
     ...
     */
    public Hämta_Utrustning(InfDB idb, Validering vemArInloggad) {
        initComponents();
    ...
    private void cbUtrustningActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbUtrustningActionPerformed
        ...
        try {
            ...
            Logger.getLogger(Hämta_Utrustning.class.getName()).log(Level.SEVERE, null, ex);
        }
