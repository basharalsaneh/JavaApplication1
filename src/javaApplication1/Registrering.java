...
public class Registrering extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
             ...
             connection1 = DriverManager.getConnection("jdbc:mysql://localhost/JavaApplication1", "root", "password"); // Denna ska också på något sätt
             // koppla upp till databasen. Ingen kod är "röd" men osäker på om projektet inte funkar pga att jag är "disconnected" från databasen eller inte.
             insert = connection1.prepareStatement("insert into alien (Alien_ID, Namn, Telefon) values (?,?,?))"); // Preparestatment = en förberedd fråga
             // att ställa till databasen.
             insert.setString(1, id); // 1an riktas till values (1,2,3). Alltså vilken plats id:t kommer på i select-frågan.
