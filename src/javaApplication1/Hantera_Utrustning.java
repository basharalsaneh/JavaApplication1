...
public class Hantera_Utrustning extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Utrustning ID");

        jButton1.setText("Ta bort");

        jLabel4.setText("Benämning");

        jLabel5.setText("Typ av vapen");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Hantera_Utrustning.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
